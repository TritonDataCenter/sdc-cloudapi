...
function loadSSHKeys(req, res, next) {
    ...
    return req.account.listKeys(function (err, keys) {
        ...
        keys.forEach(function (k) {
            req.authorized_keys += k.openssh + '\n';
        });

        log.debug({
            customer: req.account.uuid,
            authorized_keys: req.authorized_keys
...
function create(req, res, next) {
    ...
    return req.sdc.mapi.createMachine(customer, opts, function (err, machine) {
        if (err)
            return next(err);
...
function list(req, res, next) {
    ...
    return req.sdc.mapi.listMachines(customer, opts, function (err, machines) {
        if (err)
            return next(err);
...
function get(req, res, next) {
    ...
    return req.sdc.mapi.getMachine(customer, name, function (err, machine) {
        if (err)
            return next(err);
...
function start(req, res, next) {
    ...
    return req.sdc.mapi.startMachine(customer, machine, callback);
}
...
function stop(req, res, next) {
    ...
    return req.sdc.mapi.shutdownMachine(customer, machine, callback);
}
...
function reboot(req, res, next) {
    ...
    return req.sdc.mapi.rebootMachine(customer, machine, callback);
}
...
function resize(req, res, next) {
    ...
    return req.sdc.mapi.resizeZone(customer, machine, pkg, callback);
}
...
function del(req, res, next) {
    ...
    return req.sdc.mapi.deleteMachine(customer, machine, function (err) {
        if (err)
            return next(err);
