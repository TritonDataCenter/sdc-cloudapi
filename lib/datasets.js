 ...
 * the platform.
 */
function errorFromImgapiImage(image) {
    var e = {};
    ...
    case 'PrepareImageDidNotRun':
        ...
        // JSSTYLED
        //TODO e.message += ' http://wiki.joyent.com/wiki/display/jpc2/Troubleshooting+Image+Creation#PrepareImageDidNotRun'
        break;
    default:
...
function translate(req, dataset) {
    ...
    for (var i = 0; i < fieldNames.length; i++) {
        ...
        switch (field) {
        case 'error':
            obj.error = errorFromImgapiImage(dataset);
            break;
        default:
...
function mount(server, before, config) {
    ...
    server.del({
        ...
        name: 'DeleteImage',
        version: ['7.0.0', '7.1.0']
    }, bleedingEdgeGuard(config, 'img_mgmt'), before, reqBleedingEdge, del);
