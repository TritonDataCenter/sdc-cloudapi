...
/**
 * Adds _bleedingEdgeFeatures and _bleedingEdgeLoginWhitelist to the request
 * object.
 * TODO: I think we could drop these, given both can be accessed through
 * `req.config` object anyway?
 */
...
module.exports = {
    reqBleedingEdge: reqBleedingEdge,
