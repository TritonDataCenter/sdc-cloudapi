...
function doAction(req, res, next) {
    ...
    // Forward the migration mechanism (cold/live) on begin / automatic.
    // VMAPI freezes it on the record at begin time; later phases inherit.
    if ((opts.migration_action === 'begin' ||
            opts.migration_automatic === 'true') &&
            params.mechanism) {
        opts.migration_mechanism = params.mechanism;
    }
