...
function translateGroup(req, group, cb) {
    ...
    if (r.members.length) {
        pipeline_funcs.push(function _dn2uuid(_, cb) {
        ...
        pipeline_funcs.push(function _loadMembers(_, cb) {
    ...
    if (r.roles.length) {
        pipeline_funcs.push(function _rdn2uuid(_, cb) {
        ...
        pipeline_funcs.push(function _loadRoles(_, cb) {
    ...
    if (pipeline_funcs.length) {
        pipeline_funcs.push(function _translate(_, cb) {
