...
function MachineHasNoVNCError(errMsg) {
    assert.string(errMsg, 'errMsg');

    restify.RestError.call(this, {
        cause: this.constructor.prototype.cause,
        message: errMsg,
        statusCode: this.constructor.prototype.statusCode,
        restCode: this.constructor.prototype.restCode
    });
...
util.inherits(MachineHasNoVNCError, restify.RestError);
MachineHasNoVNCError.prototype.cause = 'MachineHasNoVncError';
